...
class TemporalLivenessDetector:
    ...
    def update_probability(self, real_probability: float) -> dict[str, float | int | str]:
        ...
        proposed_label = self._propose_label(temporal_probability, stable_enough)
    ...
    def _propose_label(self, temporal_probability: float, stable_enough: bool) -> str:
