...
from face_verification.metric_learning.train_siamese_mobilenetv2_kaixiang import (
    ...
    freeze_mobilenetv2_backbone,
    unfreeze_mobilenetv2_last_blocks,
)
...
def main():
    parser = argparse.ArgumentParser(
        description="Train Batch-Hard Triplet + MobileNetV2 for metric-learning recognition."
    )
    add_triplet_args(parser, TRIPLET_MOBILENETV2_DEFAULTS)
