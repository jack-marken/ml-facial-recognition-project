...
def main():
    ...
    # data_dir = script_dir / Path("datasets/mini_speech_commands/")
    ...
    # # command_dataset = tf.keras.utils.image_dataset_from_directory(train_dir, batch_size=BATCH_SIZE)
    ...
    tf.keras.layers.Input(shape=(None, 16000,)),
...
# plt.show()
# # [Nine full spectrograms with colour]
